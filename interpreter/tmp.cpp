...
# 207 "/usr/include/c++/9/bits/ptr_traits.h" 3
...
# 63 "/usr/include/c++/9/bits/stl_vector.h" 3
...
#pragma GCC visibility pop
# 64 "/usr/include/c++/9/bits/stl_vector.h" 2 3
...
# 61 "/usr/include/c++/9/bits/stl_bvector.h" 3
...
# 62 "/usr/include/c++/9/bits/stl_bvector.h" 2 3
...
# 1 "/usr/include/FlexLexer.h" 1 3 4
# 53 "/usr/include/FlexLexer.h" 3 4
...
# 117 "/usr/include/FlexLexer.h" 3 4
extern "C++" {

class 
# 119 "/usr/include/FlexLexer.h"
     MeInt_FlexLexer 
# 119 "/usr/include/FlexLexer.h" 3 4
                 : public FlexLexer {
public:


  
# 123 "/usr/include/FlexLexer.h"
 MeInt_FlexLexer
# 123 "/usr/include/FlexLexer.h" 3 4
            ( std::istream& arg_yyin, std::ostream& arg_yyout );
  
# 124 "/usr/include/FlexLexer.h"
 MeInt_FlexLexer
# 124 "/usr/include/FlexLexer.h" 3 4
...
public:
  ...
  virtual ~
# 130 "/usr/include/FlexLexer.h"
          MeInt_FlexLexer
# 130 "/usr/include/FlexLexer.h" 3 4
                     ();
...
namespace MeInt {
 ...
 class Scanner : public MeInt_FlexLexer {
 private:
...
# 226 "parser.hpp"
     "sizeof (T) <= size"
# 226 "parser.hpp" 3 4
     , "parser.hpp", 226, __extension__ __PRETTY_FUNCTION__))
# 226 "parser.hpp"
                                   ;
...
# 233 "parser.hpp"
     "!yytypeid_"
# 233 "parser.hpp" 3 4
     , "parser.hpp", 233, __extension__ __PRETTY_FUNCTION__))
# 233 "parser.hpp"
                           ;
    }
...
# 242 "parser.hpp"
     "!yytypeid_"
# 242 "parser.hpp" 3 4
     , "parser.hpp", 242, __extension__ __PRETTY_FUNCTION__))
# 242 "parser.hpp"
                           ;
...
# 243 "parser.hpp"
     "sizeof (T) <= size"
# 243 "parser.hpp" 3 4
     , "parser.hpp", 243, __extension__ __PRETTY_FUNCTION__))
# 243 "parser.hpp"
                                   ;
      yytypeid_ = & typeid (T);
...
# 294 "parser.hpp"
     "yytypeid_"
# 294 "parser.hpp" 3 4
     , "parser.hpp", 294, __extension__ __PRETTY_FUNCTION__))
# 294 "parser.hpp"
                          ;
...
# 295 "parser.hpp"
     "*yytypeid_ == typeid (T)"
# 295 "parser.hpp" 3 4
     , "parser.hpp", 295, __extension__ __PRETTY_FUNCTION__))
# 295 "parser.hpp"
                                         ;
...
# 296 "parser.hpp"
     "sizeof (T) <= size"
# 296 "parser.hpp" 3 4
     , "parser.hpp", 296, __extension__ __PRETTY_FUNCTION__))
# 296 "parser.hpp"
                                   ;
      return *yyas_<T> ();
    }
...
# 305 "parser.hpp"
     "yytypeid_"
# 305 "parser.hpp" 3 4
     , "parser.hpp", 305, __extension__ __PRETTY_FUNCTION__))
# 305 "parser.hpp"
                          ;
...
# 306 "parser.hpp"
     "*yytypeid_ == typeid (T)"
# 306 "parser.hpp" 3 4
     , "parser.hpp", 306, __extension__ __PRETTY_FUNCTION__))
# 306 "parser.hpp"
                                         ;
...
# 307 "parser.hpp"
     "sizeof (T) <= size"
# 307 "parser.hpp" 3 4
     , "parser.hpp", 307, __extension__ __PRETTY_FUNCTION__))
# 307 "parser.hpp"
                                   ;
      return *yyas_<T> ();
    }
...
# 323 "parser.hpp"
     "yytypeid_"
# 323 "parser.hpp" 3 4
     , "parser.hpp", 323, __extension__ __PRETTY_FUNCTION__))
# 323 "parser.hpp"
                          ;
...
# 324 "parser.hpp" 3 4
     (static_cast <bool> (
# 324 "parser.hpp"
     *yytypeid_ == *that.yytypeid_
# 324 "parser.hpp" 3 4
     ) ? void (0) : __assert_fail (
# 324 "parser.hpp"
     "*yytypeid_ == *that.yytypeid_"
# 324 "parser.hpp" 3 4
     , "parser.hpp", 324, __extension__ __PRETTY_FUNCTION__))
# 324 "parser.hpp"
                                              ;
  ...
  private:
    ...
    union union_type
    {
      ...
      char dummy1[sizeof (CreateTableStatement*)];


      char dummy2[sizeof (Statement*)];


      char dummy3[sizeof (TableColumnDef)];



      char dummy4[sizeof (TableColumnSpec)];
      ...
      char dummy6[sizeof (std::vector<TableColumnDef> )];
    };
    ...
    struct basic_symbol : Base
    {
      ...
      basic_symbol (typename Base::kind_type t, CreateTableStatement*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
# 548 "parser.hpp"
      ...
      {}
# 561 "parser.hpp"
      basic_symbol (typename Base::kind_type t, TableColumnDef&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
# 574 "parser.hpp"
      basic_symbol (typename Base::kind_type t, TableColumnSpec&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
# 587 "parser.hpp"
      ...
      {}
# 600 "parser.hpp"
      basic_symbol (typename Base::kind_type t, std::vector<TableColumnDef> && v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
...
switch (yytype)
    {
      case 22:
        value.template destroy< CreateTableStatement* > ();
        break;
      ...
      case 24:
        value.template destroy< TableColumnDef > ();
        break;

      case 25:
      case 26:
        value.template destroy< TableColumnSpec > ();
        break;
      ...
      case 23:
        value.template destroy< std::vector<TableColumnDef> > ();
        break;
    ...
    struct by_type
    {
      ...
      symbol_number_type type_get () const noexcept;
...
# 738 "parser.hpp" 3 4
       (static_cast <bool> (
# 738 "parser.hpp"
       tok == 0 || tok == token::TOKEN_END || tok == token::TOKEN_SEMICOLON || tok == token::TOKEN_CREATE || tok == token::TOKEN_TABLE || tok == token::TOKEN_UNIQUE || tok == token::TOKEN_PRIMARY || tok == token::TOKEN_KEY || tok == token::TOKEN_INT || tok == token::TOKEN_FLOAT || tok == token::TOKEN_CHAR || tok == token::TOKEN_QUIT || tok == token::TOKEN_LPAREN || tok == token::TOKEN_RPAREN || tok == token::TOKEN_COMMA
# 738 "parser.hpp" 3 4
       ) ? void (0) : __assert_fail (
# 738 "parser.hpp"
       "tok == 0 || tok == token::TOKEN_END || tok == token::TOKEN_SEMICOLON || tok == token::TOKEN_CREATE || tok == token::TOKEN_TABLE || tok == token::TOKEN_UNIQUE || tok == token::TOKEN_PRIMARY || tok == token::TOKEN_KEY || tok == token::TOKEN_INT || tok == token::TOKEN_FLOAT || tok == token::TOKEN_CHAR || tok == token::TOKEN_QUIT || tok == token::TOKEN_LPAREN || tok == token::TOKEN_RPAREN || tok == token::TOKEN_COMMA"
# 738 "parser.hpp" 3 4
       , "parser.hpp", 738, __extension__ __PRETTY_FUNCTION__))
# 738 "parser.hpp"
                                                                                                                                                                                                                                                                                                                                                                                                                                                   ;
      }
# 748 "parser.hpp"
...
# 751 "parser.hpp" 3 4
       (static_cast <bool> (
# 751 "parser.hpp"
       tok == token::TOKEN_NUMBER || tok == token::TOKEN_IDENTIFIER
# 751 "parser.hpp" 3 4
       ) ? void (0) : __assert_fail (
# 751 "parser.hpp"
       "tok == token::TOKEN_NUMBER || tok == token::TOKEN_IDENTIFIER"
# 751 "parser.hpp" 3 4
       , "parser.hpp", 751, __extension__ __PRETTY_FUNCTION__))
# 751 "parser.hpp"
                                                                               ;
      }
     ...
     Parser (MeInt::Scanner &scanner_yyarg, MeInt::Interpreter &driver_yyarg);
    virtual ~ Parser ();
...
# 858 "parser.hpp"
      ...
      {
        return symbol_type (token::TOKEN_UNIQUE, std::move (l));
      }
# 873 "parser.hpp"
      static
      symbol_type
      make_PRIMARY (location_type l)
      {
        return symbol_type (token::TOKEN_PRIMARY, std::move (l));
      }
# 888 "parser.hpp"
      static
      symbol_type
...
# 948 "parser.hpp"
      ...
      {
        return symbol_type (token::TOKEN_QUIT, std::move (l));
      }
# 963 "parser.hpp"
      static
      symbol_type
...
# 1039 "parser.hpp"
  ...
  private:
    ...
    struct by_state
    {
      ...
      by_state (kind_type s) noexcept;


      by_state (const by_state& that) noexcept;
    ...
    struct stack_symbol_type : basic_symbol<by_state>
    {
      ...
      stack_symbol_type (stack_symbol_type&& that);
...
# 1196 "parser.hpp"
    ...
    public:
      ...
      void
      pop (std::ptrdiff_t n = 1) noexcept
      {
        for (; 0 < n; --n)
          seq_.pop_back ();
      }
    ...
    MeInt::Scanner &scanner;
    MeInt::Interpreter &driver;
  };
    ...
    , location (std::move (that.location))
  {
    ...
    {
      case 22:
        value.move< CreateTableStatement* > (std::move (that.value));
        break;
      ...
      case 24:
        value.move< TableColumnDef > (std::move (that.value));
        break;

      case 25:
      case 26:
        value.move< TableColumnSpec > (std::move (that.value));
        break;
      ...
      case 23:
        value.move< std::vector<TableColumnDef> > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    ...
    {
      case 22:
        value.copy< CreateTableStatement* > (std::move (that.value));
        break;

      case 21:
        value.copy< Statement* > (std::move (that.value));
        break;

      case 24:
        value.copy< TableColumnDef > (std::move (that.value));
        break;

      case 25:
      case 26:
        value.copy< TableColumnSpec > (std::move (that.value));
        break;

      case 14:
      case 15:
      case 27:
        value.copy< std::string > (std::move (that.value));
        break;

      case 23:
        value.copy< std::vector<TableColumnDef> > (std::move (that.value));
        break;
  ...
  template <typename Base>
  bool
   Parser ::basic_symbol<Base>::empty () const noexcept
  {
   ...
   Parser ::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    {
      case 22:
        value.move< CreateTableStatement* > (std::move (s.value));
        break;

      case 21:
        value.move< Statement* > (std::move (s.value));
        break;

      case 24:
        value.move< TableColumnDef > (std::move (s.value));
        break;

      case 25:
      case 26:
        value.move< TableColumnSpec > (std::move (s.value));
        break;

      case 14:
      case 15:
      case 27:
        value.move< std::string > (std::move (s.value));
        break;

      case 23:
        value.move< std::vector<TableColumnDef> > (std::move (s.value));
        break;
  ...
  inline
  int
   Parser ::by_type::type_get () const noexcept
  {
    return type;
  }
# 15 "parser.y"
